...
7. 初试科目必须精确：区分英语一/英语二、数学一/数学二/数学三，不要笼统写"英语"、"数学"
8. 科目格式示例：["政治", "英语一", "数学一", "408统考"] 或 ["政治", "英语二", "数学二", "408统考"]
9. 忽略"灰灰考研统计"、"皮皮灰统计"等水印文字
10. 忽略"一志愿被刷统计"等无关内容
11. 复试信息必须提取：复试时间、复试形式、复试内容、成绩计算方式
12. 如果文本中有"上机能力测试"、"面试"等信息，要提取到retestInfo.content中
13. 如果文本中有"总成绩=初试成绩×50%+复试成绩×50%"等信息，要提取到retestInfo.scoreRule中
