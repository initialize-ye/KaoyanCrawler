                ...
                for s in result.get("subjects", []):
                    try:
                        subject = ExamSubject(
                            ...
                            retest_score_line=s.get("retest_score_line"),
                            retest_count=s.get("retest_count"),
                            retest_avg_score=s.get("retest_avg_score"),
                            admission_count=s.get("admission_count"),
                            admission_ratio=s.get("admission_ratio"),
                            admission_min_score=s.get("admission_min_score"),
                            admission_median_score=s.get("admission_median_score"),
                            admission_max_score=s.get("admission_max_score"),
                            admission_avg_score=s.get("admission_avg_score"),
                            transfer_type=str(s.get("transfer_type", "")),
                            source_url=req.url,
                        )
